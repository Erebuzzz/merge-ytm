            ...
            <div className="mt-auto p-6 space-y-4">
              <div className="flex flex-col gap-3">
                ...
                <div className="flex flex-wrap gap-3 text-sm font-medium text-text-muted">
                  ...
                  <a href="https://github.com/Erebuzzz/merge-ytm" target="_blank" rel="noreferrer" title="GitHub" className="hover:text-white transition-colors tracking-tighter">GitHub</a>
                ...
                <div className="text-xs text-text-muted mt-1">
                  <a href="https://github.com/Erebuzzz/merge-ytm" target="_blank" rel="noreferrer" className="flex items-center gap-2 hover:text-brand-spotify transition-colors font-semibold">
                    ⭐ Star Merge
                  </a>
                </div>
              </div>
