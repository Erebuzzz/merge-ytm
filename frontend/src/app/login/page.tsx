    ...
    <div className="flex items-center justify-center min-h-[60vh] md:min-h-[70vh] animate-fade-in-up">
      <div className="w-full max-w-sm mx-auto">
        <div className="glass-panel rounded-2xl md:rounded-3xl p-6 md:p-8 relative overflow-hidden">
          ...
          <div className="absolute -top-24 left-1/2 -translate-x-1/2 w-48 h-48 bg-brand-ytmusic/15 blur-[80px] rounded-full pointer-events-none" />

          <div className="relative z-10">
            <h1 className="text-display-sm font-display text-white text-center mb-1">Welcome back</h1>
            <p className="text-xs text-text-muted text-center mb-8">
              Sign in to access your blends and library
            </p>
            ...
            <p className="mt-6 text-center text-[11px] text-text-muted">
              ...
              <Link href="/register" className="text-brand-spotify hover:text-white transition-colors font-semibold">
                Sign up
              </Link>
            </p>
          </div>
